...
@author: fahad
@purpose : a MLP to predict RUL for the C-mapss dataset using a dynamic MLP. This cope is deisgned to run for CPU
...
# GA generated featuers
#col =[1,3,5,6,10,16,17,18,19]
#col =[3,7,8,12,18,19,20,21]
...
start = time.time()
history = model.fit(X_train, y_train, batch_size = 64, epochs = 1000, shuffle=False, verbose=False, callbacks=[es], validation_split=0.2)
end = time.time()
