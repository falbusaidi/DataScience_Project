...
@author: fahad
@purpose : a MLP to predict RUL for the C-mapss dataset using a static MLP. This cope is deisgned to run for GPU
...
# early stopping 
es = EarlyStopping(monitor='val_loss', min_delta=0, patience=2, verbose=False)
